...
<body>
    <div id="bigcontainer">
        <div id="head">
            <div class="top">
                <div class="head_img">
                <img id="school" src="html/images/hfut_03.png" alt="合肥工业大学" style="float:left; margin-top:6px">
                <img src="html/images/hfut_03.jpg" style="float:right;">
                </div>
            </div>
        </div>
                ...
                <div id="mid_left">
                    ...
                    <div id="news"> 
                        ...
                        <div id="jdxw">
                            ...
                            <div class="scroll">
                                <ul class="slide_01" id="slide_01">
                                    <li class="mod_01"><a href="<{$image_0_url}>" target="_blank"><img src="<{$image_0_image}>" alt="<{$image_0_title}>"></a><h3 class="htitle"><a title="<{$image_0_title}>" href="<{$image_0_url}>" target="_blank"><{$image_0_title}></a></h3></li>
                                    <li class="mod_01"><a href="<{$image_1_url}>" target="_blank"><img src="<{$image_1_image}>" alt="<{$image_1_title}>"></a><h3 class="htitle"><a title="<{$image_1_title}>" href="<{$image_1_url}>" target="_blank"><{$image_1_title}></a></h3></li>
                                    <li class="mod_01"><a href="<{$image_2_url}>" target="_blank"><img src="<{$image_2_image}>" alt="<{$image_2_title}>"></a><h3 class="htitle"><a title="<{$image_2_title}>" href="<{$image_2_url}>" target="_blank"><{$image_2_title}></a></h3></li>
                                    <li class="mod_01"><a href="<{$image_3_url}>" target="_blank"><img src="<{$image_3_image}>" alt="<{$image_3_title}>"></a><h3 class="htitle"><a title="<{$image_3_title}>" href="<{$image_3_url}>" target="_blank"><{$image_3_title}></a></h3></li>
                                    <li class="mod_01"><a href="<{$image_4_url}>" target="_blank"><img src="<{$image_4_image}>" alt="<{$image_4_title}>"></a><h3 class="htitle"><a title="<{$image_4_title}>" href="<{$image_4_url}>" target="_blank"><{$image_4_title}></a></h3></li>                            
                                </ul>
                                <div>
...
<script type="text/javascript">
	...
	$(window).load(function(){
		$('#slider').nivoSlider({startSlide:rand,controlNav:false,animSpeed:800,pauseTime:8000});
	});
</script>
